# Copied from https://github.com/OpenZeppelin/cairo-contracts/pull/239
# TODO Remove when openzeppelin 0.2.0 is released
...
namespace AccessControl:
    ...
    func _only_role{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}(role : felt):
