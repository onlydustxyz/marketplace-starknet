...
func test_same_contribution_cannot_be_added_twice{
    ...
    let (contribution2) = contributions.new_contribution(ID1, PROJECT_ID, 0)
    %{ stop_prank() %}
...
func test_can_assign_gated_contribution_eligible_contributor{
    ...
    let (_) = contributions.new_contribution(ID2, PROJECT_ID, 1)
