...
func test_e2e{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr}():
    ...
    %{
        expect_events(
            { "name": "ProjectMemberAdded", "data": { "project_id": ids.PROJECT_ID,  "contributor_account":  ids.CONTRIBUTOR, "contributor_id": {"low": ids.user.contributor_id.low, "high": ids.user.contributor_id.high} }},
        )
    %}
